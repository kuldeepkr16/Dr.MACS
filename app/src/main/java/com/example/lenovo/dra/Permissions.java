...
public abstract class Permissions extends Fragment {
    ...
    public void requestAppPermissions(final String[]requestedPermissions, final int stringId, final int requestCode) {
        ...
        if (permissionCheck!=PackageManager.PERMISSION_GRANTED) {
            if(showRequestPermissions) {
                Snackbar.make(getView().findViewById(android.R.id.content), stringId, Snackbar.LENGTH_INDEFINITE).setAction("GRANT", new View.OnClickListener() {
                    @Override
        ...
        if( (grantResults.length > 0) && PackageManager.PERMISSION_GRANTED == permissionCheck) {
            ...
            Snackbar.make(getView().findViewById(android.R.id.content), mErrorString.get(requestCode),
                ...
                public void onClick(View v) {
                    ...
                    i.setData(Uri.parse("package:" + getActivity()));
