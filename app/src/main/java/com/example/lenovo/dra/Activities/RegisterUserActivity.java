...
public class RegisterUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(RegisterUserActivity.this, ShowTerms.class));
            }
        });
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(validateInputs() == 1){
                    Toast.makeText(RegisterUserActivity.this, "Please Fill All The Details!!", Toast.LENGTH_LONG).show();
                    return;
                }
                else if(validateInputs() == 2){
                    Toast.makeText(RegisterUserActivity.this, "You Must Accept Terms And Conditions!!", Toast.LENGTH_LONG).show();
                    return;
                }
                else if(validateInputs() == 3){
                    Toast.makeText(RegisterUserActivity.this, "Please Choose Your Gender!", Toast.LENGTH_LONG).show();
                    return;
                }
                else if(validateInputs() == 4){
                    Toast.makeText(RegisterUserActivity.this, "Please Choose A Password Of Atleast 6 Characters!", Toast.LENGTH_LONG).show();
                    return;
                }
                else if(validateInputs() == 5){
                    Toast.makeText(RegisterUserActivity.this, "Enter Correct Phone Number", Toast.LENGTH_LONG).show();
                    return;
                }
                else if(validateInputs() == 6){
                    Toast.makeText(RegisterUserActivity.this, "Enter Correct PIN", Toast.LENGTH_LONG).show();
                    return;
                }
                registerUser();
                    Toast.makeText(RegisterUserActivity.this, "Registration Successful! Login To Continue", Toast.LENGTH_SHORT).show();
