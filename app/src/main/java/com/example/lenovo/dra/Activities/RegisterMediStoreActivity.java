...
public class RegisterMediStoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(RegisterMediStoreActivity.this, ShowTerms.class));
            }
        });
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(validateInputs() == 1){
                    Toast.makeText(RegisterMediStoreActivity.this, "Please Fill All The Details!!", Toast.LENGTH_LONG).show();
                    return;
                }
                    ...
                    Toast.makeText(RegisterMediStoreActivity.this, "Please Choose A Password Of Atleast 6 Characters!", Toast.LENGTH_LONG).show();
                    return;
                }
                else if(validateInputs() == 5){
                    Toast.makeText(RegisterMediStoreActivity.this, "Enter Correct Phone Number", Toast.LENGTH_LONG).show();
                    return;
                }
                else if(validateInputs() == 6){
                    Toast.makeText(RegisterMediStoreActivity.this, "Enter Correct PIN", Toast.LENGTH_LONG).show();
                    return;
                }
                registerUser();
                Toast.makeText(RegisterMediStoreActivity.this, "Registration Successful! Login To Continue", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(RegisterMediStoreActivity.this, LoginActivity.class));
            }
        });
    }
