...
public class OnReceivingMedicineConfirmation extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_on_receiving_medicine_confirmation);

        TextView txtConfirmName = (TextView) findViewById(R.id.txtMediConfirmStoreName);
        TextView txtConfirmPhoneNo = (TextView) findViewById(R.id.txtMediConfirmPhoneNo);
    ...
    private void senToMainActivity() {
        startActivity(new Intent(OnReceivingMedicineConfirmation.this, MainActivity.class));
        finish();
    }
}
